...
* **haproxy:** add haproxy:set-timeouts command ([773724d](https://github.com/slmingol/pfsense-cli/commit/773724d0895de024a363ce3b43791b904f62942c))
...
* document HAProxy frontend management commands in README ([1b557d4](https://github.com/slmingol/pfsense-cli/commit/1b557d4aa74f9d6fdd8f504c4ede3a13561a6848))
...
* update RECOVERY.md with actual backup architecture ([73d8e57](https://github.com/slmingol/pfsense-cli/commit/73d8e5785bd0e47c4501f753eab096083c2dee65))
...
* add missing haproxy Makefile targets (use-ip, disable-resolver, inspect, apply, restart) ([3b89c1a](https://github.com/slmingol/pfsense-cli/commit/3b89c1a752af2db16d7abe0d12357f19891b4a76))
...
* document haproxy:use-ip, inspect, apply, restart, disable-resolver and cert-check-schedule in README ([5743f8f](https://github.com/slmingol/pfsense-cli/commit/5743f8f911c438819bca97ecda66b0447cfa6313))
