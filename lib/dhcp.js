...
async function updateStaticMapping({ iface, mac, ...fields }) {
  ...
  if (fields.ip          != null) patch.ipaddr    = fields.ip;
  if (fields.hostname    != null) patch.hostname  = fields.hostname;
  if (fields.description != null) patch.descr     = fields.description;
  if (fields.dns?.length)         patch.dnsserver = fields.dns;
  if (fields.gateway     != null) patch.gateway   = fields.gateway;
