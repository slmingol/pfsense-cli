...
async function listEntries(filter = null) {
  ...
  try {
    ...
    throw new Error(`Failed to list entries: ${error.response?.data?.message || error.message}`, { cause: error });
  }
}
...
async function addEntry({ host, domain, ip, description }) {
  ...
  try {
    ...
    throw new Error(`Failed to add entry: ${error.response?.data?.message || error.message}`, { cause: error });
  }
}
...
async function updateEntry({ host, domain, ip, description }) {
  ...
  try {
    ...
    throw new Error(`Failed to update entry: ${error.response?.data?.message || error.message}`, { cause: error });
  }
}
...
async function deleteEntry(host, domain) {
  ...
  try {
    ...
    throw new Error(`Failed to delete entry: ${error.response?.data?.message || error.message}`, { cause: error });
  }
}
...
async function applyChanges(client) {
  try {
    ...
    console.log(`  ${c.gray}✓ DNS Resolver applied${c.reset}`);
  } catch {
...
async function addAlias({ host, domain, aliasHost, aliasDomain, description }) {
  ...
  try {
    ...
    throw new Error(`Failed to add alias: ${error.response?.data?.message || error.message}`, { cause: error });
  }
}
...
async function deleteAlias({ host, domain, aliasHost, aliasDomain }) {
  ...
  try {
    ...
    throw new Error(`Failed to delete alias: ${error.response?.data?.message || error.message}`, { cause: error });
  }
}
